...
function esVocal(letra){
  ...
  //Escribe tu código aquí
  var test = letra.includes("a") || letra.includes("e") || letra.includes("i") || letra.includes("o") || letra.includes("u");  if(letra.length > 1) {
